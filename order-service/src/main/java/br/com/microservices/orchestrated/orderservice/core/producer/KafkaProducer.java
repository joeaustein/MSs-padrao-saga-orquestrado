...
import br.com.microservices.orchestrated.orderservice.config.kafka.KafkaConfig;
...
public class KafkaProducer {
    ...
    public void sendEvent(String payload) {
        try {
            ...
            log.error("Error trying to send event to topic {} with data {}: {}", startSagaTopic, e.getMessage());
        }
    }
}
